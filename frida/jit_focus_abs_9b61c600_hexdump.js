// Focused absolute hook for 0x9b61c600 using Frida's hexdump() helper.

'use strict';

(function () {
    if (globalThis.__jitFocusAbs61c600Hex && globalThis.__jitFocusAbs61c600Hex.installed) {
        console.log('[CAPTURE] [ABS61C600HEX] relay already installed');
        return;
    }

    var state = globalThis.__jitFocusAbs61c600Hex = {
        installed: true,
        counts: {},
        seenX1: {},
    };

    var TARGET = ptr('0x9b61c600');
    ...
    console.log('[CAPTURE] [ABS61C600HEX] target=' + TARGET);
    ...
    Interceptor.attach(TARGET, {
        onEnter: function () {
            ...
            console.log('[CAPTURE] [ABS61C600HEX] ' + JSON.stringify({
                kind: 'enter',
                count: count,
